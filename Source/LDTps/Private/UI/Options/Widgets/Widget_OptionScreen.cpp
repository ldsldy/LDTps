...
#include "UI/Options/Widgets/Widget_OptionScreen.h"
#include "Input/CommonUIInputTypes.h"
#include "ICommonInputModule.h"
#include "UI/Options/Data/OptionsDataRegistry.h"
#include "UI/Components/LDTpsCommonTabListWidgetBase.h"
#include "UI/Options/DataObjects/ListDataObject_Collection.h"
#include "UI/Components/LDTpsCommonListView.h"
#include "Core/Settings/LDTpsGameUserSettings.h"
#include "UI/Options/ListEntries/Widget_ListEntry_Base.h"
#include "UI/Options/Widgets/Widget_OptionsDetailsView.h"
#include "UI/Subsystems/LDTpsUISubsystem.h"
...
void UWidget_OptionScreen::OnResetBoundActionTriggered()
{
	...
	const FString SelectedTabButtonName = CastChecked<ULDTpsCommonButtonBase>(SelectedTabButton)->GetButtonDisplayText().ToString();
	...
	ULDTpsUISubsystem::Get(this)->PushConfirmScreenToModalStackAynsc(
		...
		FText::FromString(TEXT("선택한 ") + SelectedTabButtonName + TEXT(" 탭 아래의 모든 설정을 초기화하시겠습니까?")),
