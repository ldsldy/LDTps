...
#include "Common/UI/Settings/Data/DataAsset_DataListEntryMapping.h"
...
UUserWidget& ULDTpsCommonListView::OnGenerateEntryWidgetInternal(UObject* Item, TSubclassOf<UUserWidget> DesiredEntryClass, const TSharedRef<STableViewBase>& OwnerTable)
{
	if (IsDesignTime())
	{
...
#if WITH_EDITOR
void ULDTpsCommonListView::ValidateCompiledDefaults(IWidgetCompilerLog& CompileLog) const
{
