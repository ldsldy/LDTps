...
#include "Common/UI/Widgets/Widget_ActivatableBase.h"
#include "Common/UI/Types/LDTPSUIEnum.h"
#include "Widget_OptionScreen.generated.h"

class UOptionsDataRegistry;
class ULDTpsCommonTabListWidgetBase;
class ULDTpsCommonListView;
...
private:
	...
	ULDTpsCommonTabListWidgetBase* TabListWidget_OptionsTabs;

	UPROPERTY(meta = (BindWidget))
	ULDTpsCommonListView* CommonListView_OptionsList;
